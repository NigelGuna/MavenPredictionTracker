...
public class PredictionController {
    ...
    public Prediction addPaymentLoan(@RequestBody Prediction prediction) {
        try {
    ...
    public Prediction updatePrediction(@PathVariable("id") int matchId, @RequestBody Prediction prediction) {
        try {
            return predictionService.updatePrediction(matchId, prediction);
        } catch (Exception e) {
            throw new CustomExceptions(e.getMessage());
        }
    }
